...
export const INITIAL_MOCK_POLLS: Poll[] = [
  {
    id: 2001,
    creator: { id: 999, username: 'SurveyAdmin', avatar: 'https://picsum.photos/120/120', points: 5000, pollsCreated: 42, pollsVotedOn: [], following: [], followers: [], pollsCount: 0 },
  ...
  {
    id: 1020,
    creator: { id: 112, username: 'MarketingTeam', avatar: 'https://picsum.photos/112/112', points: 1200, pollsCreated: 8, pollsVotedOn: [], following: [], followers: [], pollsCount: 0 },
  ...
  {
    id: 1022,
    creator: { id: 114, username: 'CommunityMgr', avatar: 'https://picsum.photos/114/114', points: 1500, pollsCreated: 12, pollsVotedOn: [], following: [], followers: [], pollsCount: 0 },
  ...
  {
    id: 1,
    creator: { id: 101, username: 'SportsFanatic', avatar: 'https://picsum.photos/101/101', points: 500, pollsCreated: 5, pollsVotedOn: [], following: [], followers: [], pollsCount: 0 },
    ...
    comments: [
      { id: 1, user: { id: 102, username: 'CricketFan', avatar: 'https://picsum.photos/102/102', points: 100, pollsCreated: 0, pollsVotedOn: [], following: [], followers: [], pollsCount: 0 }, text: 'India has the home advantage!', likes: 15, timestamp: new Date(now.getTime() - 2 * 60 * 60000) },
      { id: 2, user: { id: 103, username: 'AussieFan', avatar: 'https://picsum.photos/103/103', points: 200, pollsCreated: 0, pollsVotedOn: [], following: [], followers: [], pollsCount: 0 }, text: 'Never count out Australia.', likes: 4, timestamp: new Date(now.getTime() - 10 * 60000) }
    ],
    likes: 1200,
    dislikes: 50,
    category: 'Sports',
  ...
  {
    id: 1021,
    creator: { id: 113, username: 'ProductManager', avatar: 'https://picsum.photos/113/113', points: 2000, pollsCreated: 25, pollsVotedOn: [], following: [], followers: [], pollsCount: 0 },
  ...
  {
    id: 99,
    creator: { id: 109, username: 'HistoryKeeper', avatar: 'https://picsum.photos/109/109', points: 800, pollsCreated: 10, pollsVotedOn: [], following: [], followers: [], pollsCount: 0 },
  ...
  {
    id: 100,
    creator: { id: 110, username: 'BetaTester', avatar: 'https://picsum.photos/110/110', points: 100, pollsCreated: 1, pollsVotedOn: [], following: [], followers: [], pollsCount: 0 },
  ...
  {
    id: 4,
    creator: { id: 105, username: 'Foodie', avatar: 'https://picsum.photos/104/104', points: 300, pollsCreated: 12, pollsVotedOn: [], following: [], followers: [], pollsCount: 0 },
  ...
  {
    id: 3,
    creator: { id: 102, username: 'MovieLover', avatar: 'https://picsum.photos/105/105', points: 400, pollsCreated: 2, pollsVotedOn: [], following: [], followers: [], pollsCount: 0 },
    question: 'Which blockbuster will gross more worldwide?',
    pollType: 'image',
    options: [{ id: 'a', text: 'Cyber Runner 3049' }, { id: 'b', text: 'Chronicles of Atheria' }],
    votes: { a: 980, b: 1120 },
    comments: [{ id: 3, user: { id: 104, username: 'FilmBuff', avatar: 'https://picsum.photos/106/106', points: 50, pollsCreated: 0, pollsVotedOn: [], following: [], followers: [], pollsCount: 0 }, text: 'The sci-fi one looks amazing!', likes: 8, timestamp: new Date(now.getTime() - 15 * 60000) }],
    likes: 540,
    dislikes: 12,
    category: 'Movies',
  ...
  {
    id: 5,
    creator: { id: 106, username: 'TravelBug', avatar: 'https://picsum.photos/107/107', points: 600, pollsCreated: 22, pollsVotedOn: [], following: [], followers: [], pollsCount: 0 },
  ...
  {
    id: 2,
    creator: { id: 103, username: 'TechGuru', avatar: 'https://picsum.photos/108/108', points: 900, pollsCreated: 8, pollsVotedOn: [], following: [], followers: [], pollsCount: 0 },
